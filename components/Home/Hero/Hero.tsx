...
const Hero = () => {
  return (
    <div id="Hero" className="relative bg-blue-950 w-full h-screen flex justify-center flex-col items-center ">
      <div className="w-[90%] md:w-[80%] mx-auto items-center pt-7 grid grid-cols-1 xl:grid-cols-2 gap-10 ">
        {/* Text content */}
        <div data-aos="fade-up">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl mt-6 mb-6 font-bold text-white leading-[2.5rem] md:leading-[4rem] ">
            Providing software for your any{" "}
          ...
          <p className="text-sm sm:text-base md:text-lg font-medium text-gray-300">
            ...
            software solutions for businesses of all sizes. Our team of
            experienced developers and designers work together to create custom
          ...
          >
            ...
            <span className="relative w-full text-left font-bold text-black transition-colors duration-300 ease-in-out group-hover:text-white">Discover More</span>
          </a>
        </div>
        {/* image content */}
