       ...
       <div className='text-center'>
        ...
        <div className='w-[80%] mt-16 mx-auto grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 '>
          <div data-aos="fade-right">
            <BlogCard image="/images/b1.png" title="Export Advice for Growing Your Digital Presence" />
          </div>
          <div data-aos="fade-right"  data-aos-delay="100">
            <BlogCard image="/images/b2.png" title="Data-Driven Strategies and Case Studies Success" />
          </div>
          <div data-aos="fade-right"  data-aos-delay="200">
            <BlogCard image="/images/b3.png" title="The Complete SEO Blog for Digital Success" />
          </div>
        </div>
    </div>
  )
