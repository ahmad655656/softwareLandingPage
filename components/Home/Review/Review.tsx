        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="text-xl sm:text-3xl md:text-4xl mt-1 font-bold">
              Trusred By Industry Leaders Clients Testimonial
            </h1>
          </div>
          <div className="lg:ml-auto">
            <a
              href="#_"
              className="w-full py-4 text-base sm:text-lg md:text-xl text-center text-white transition-colors font-semibold duration-300 bg-blue-800 rounded-full uppercase hover:bg-blue-900 ease-out md:w-auto px-9"
            >
              All Reviews
            </a>
          </div>
